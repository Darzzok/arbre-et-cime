...
export const metadata: Metadata = {
  ...
  description:
    "Cette page n’existe pas ou plus. Retrouvez les prestations d’élagage, d’abattage et d’entretien des espaces verts d’Arbres et Cimes, ou demandez un devis.",
  robots: {
    index: false,
    follow: true,
